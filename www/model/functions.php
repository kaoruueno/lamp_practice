...
*/
function entity_triple_array($triple_array) {
  foreach ($triple_array as $key3 => $double_array) { 
    foreach ($double_array as $key2 => $array) {
      ...
      $double_array[$key2] = $array;
    }
    $triple_array[$key3] = $double_array;
  }
  return $triple_array;
}
